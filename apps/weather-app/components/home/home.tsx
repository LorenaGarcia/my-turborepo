...
import { UnitState } from "../units-dropdown/units-dropdown.types";
import { UNITS } from "../units-dropdown/units-dropdown.constants";
...
function Home() {
  ...
  const [units, setUnits] = useState<UnitState>(UNITS);
    ...
    <div className="px-4 py-4 md:p-8 max-w-[1400px] mx-auto min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6 md:mb-10 lg:mb-8">
        <div className="flex items-center gap-2">
          <Flower />
          <p className="text-[20px] md:text-[22px] font-bold text-white">
            Weather Now
          </p>
        </div>
        <UnitsDropdown units={units} onChangeUnits={setUnits} />
      </div>
